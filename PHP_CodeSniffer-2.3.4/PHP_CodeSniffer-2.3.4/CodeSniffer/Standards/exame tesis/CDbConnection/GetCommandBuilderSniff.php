 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Yii_Sniffs_CDbConnection_GetCommandBuilderSniff implements PHP_CodeSniffer_Sniff
{
        ...
        if ($tokens[$stackPtr]['content'] === 'getCommandBuilder') {
           ...
           //Devuelve el constructor de comandos SQL para la conexion BD actual.
            ...
            //if ((!strpos($name, "models")) )  {
                 $error = 'Returns the SQL command builder for the current DB connection.; found %s';
