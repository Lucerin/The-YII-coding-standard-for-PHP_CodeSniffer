 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Yii_Sniffs_CDbDataReader_NextResultSniff implements PHP_CodeSniffer_Sniff
{
        ...
        if ($tokens[$stackPtr]['content'] === 'nextResult') {
           ...
           //Avanza el lector al siguiente resultado cuando la lectura de los resultados de un lote de instrucciones.
            ...
            //if ((!strpos($name, "models")) )  {
                 $error = 'Advances the reader to the next result when reading the results of a batch of statements.; 
                 found %s';
