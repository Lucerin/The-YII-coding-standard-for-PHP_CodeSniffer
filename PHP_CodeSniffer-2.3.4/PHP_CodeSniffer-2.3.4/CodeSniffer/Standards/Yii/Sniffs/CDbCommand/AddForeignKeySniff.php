 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Yii_Sniffs_CDbCommand_AddForeignKeySniff implements PHP_CodeSniffer_Sniff
{
        ...
        if ($tokens[$stackPtr]['content'] === 'addForeignKey') {
           ...
           //Construye una sentencia SQL para añadir una restricción de clave foránea a una tabla existente.
            ...
            //if ((!strpos($name, "models")) )  {
                 $error = 'Builds a SQL statement for adding a foreign key constraint to an existing table.; 
                 found %s';
