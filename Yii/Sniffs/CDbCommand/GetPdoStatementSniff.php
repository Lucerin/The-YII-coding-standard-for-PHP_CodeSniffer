 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Yii_Sniffs_CDbCommand_GetPdoStatementSniff implements PHP_CodeSniffer_Sniff
{
        ...
        if ($tokens[$stackPtr]['content'] === 'getPdoStatement') {
           ...
           //Devuelve la Declaración DOP subyacente para este comando podría ser nula si la declaración no está preparado todavía.
            ...
            //if ((!strpos($name, "models")) )  {
                 $error = 'Returns the underlying PDOStatement for this command It could be null if the statement is not prepared yet.; 
                 found %s';
